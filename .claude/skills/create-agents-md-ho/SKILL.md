...
description: Generate AGENTS.md, CLAUDE.md, and .claude/rules/ files for any repository following industry best practices. Explores the codebase, identifies tech stack, patterns, and conventions, then creates comprehensive agent instruction files.
---
