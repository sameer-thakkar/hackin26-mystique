          ...
          <ol>
            ...
            <li>
              ...
              <Paragraph>
                ...
                <ol>
                  <li>
                    <b>Account</b> means a unique account created for You on the
                    Platform to access Our service or parts of Our service.
                  </li>
                  <li>
                    <b>Company</b> (referred to as either &quot;Headout&quot;,
                    &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Headout. Inc.,
                    its affiliates, subsidiaries and/or any other body corporate
                    related to Headout.
                  </li>
                  <li>
                  ...
                  <li>
                    <b>Personal Information</b> is any information that relates
                    to an identified or identifiable User who is a natural
                    person and that is shared by such User while availing
                    services available on the Platform. Headout collects this
                    from the User for the purpose of providing services on the
                    Platform and fulfilling its different legal obligations.
                    Please refer to pointer 5 (What type of Personal Information
                    is collected by Headout?) for detailed information.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    document and amendments that may be made to this document in
                    future. This shall also include any other document that
                  ...
                  <li>
                    ...
                    the Company in different scenarios and/or to create a login
                  ...
                  <li>
                    ...
                    third parties may also be engaged by the Company for better
                    facilitation of services available on the Platform which
              ...
              <Paragraph>
                <ol>
                  <li>
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        person in specific. This data could also be anonymous in
                        nature. This data includes but is not limited to
                        aggregated data around the use of services available on
                        the Platform, masked IP addresses etc. <br />
                        &quot;Personally Identifiable Information&quot; is
                        information that is personally identifiable to You and
                        that can be used to distinguish or trace Your identity.
                        This information is also collected by Us in order to
                        provide You with access to certain features of Our
                        Platform. This information includes but is not limited
                        to information such as name, social security number,
                        date and place of birth, phone number, address, email
                        ID, payment/card details etc.
                      </li>
                    </ol>
                  </li>
                  <li>
                    ...
                    <ol>
                      <li>
                        ...
                        gets automatically captured. This automated information
                        that We capture falls under the Non-Identifiable
                        Personal Information category. Following are the broad
                        types of information that get automatically captured:
                        <ul>
                          <li>
                          ...
                          <li>
                            IP information is also captured when You access the
                            Platform.
                          </li>
                          <li>
                      ...
                      <li>
                        All the aforesaid information captured automatically is
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            behaviour so that the best services can be provided
                            to You;
                          </li>
                          <li>
                            In the event of specific indications of criminal
                            offences, to enable criminal prosecution, avoidance
                            of harm, or legal punishment;
                          </li>
                        </ul>
                      </li>
                    </ol>
                  ...
                  <li>
                    ...
                    <ol>
                      <li>
                        Additionally, We also use different types of cookies to
                        track Your usage of Our Platform and store certain
                        information that further helps us to provide You with
                        more personalized services. There are certain cookies
                        that may get placed on Your Device because of Your usage
                        of any services available on Our Platform.
                      </li>
                      <li>
                        Broadly, We use two different sets of technologies under
                        this head i.e.:
                        <ul>
                          <li>
                            <b>Cookies or Browser Cookies.</b> it is a small
                            file that automatically gets placed on Your Device
                            when You access Our Platform. You can instruct Your
                            browser to refuse all Cookies or to indicate when a
                            cookie should be saved. In case, if You do not
                            accept Our Cookies, You may not be able to use some
                            parts of Our Platform.{' '}
                          </li>
                          <li>
                            <b>Web Beacons.</b> Also referred to as clear gifs,
                            pixel tags, and single-pixel gifs that are attached
                            in various sections of Our Platform and Our emails
                            that permit us to monitor and understand the
                            activity of Users.
                          </li>
                        </ul>
                      </li>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            ...
                            <Paragraph className="reduced-margin-top">
                              <span className="italic-underline">Purpose:</span>{' '}
                              These Cookies are essential for You to access
                              different sections of the Platform and if these
                              are not allowed You may not be able to access the
                              services available on the Platform. These cookies
                              further help us to authenticate the Users and
                              prevent any sort of fraudulent activity on the
                              Platform.
                            </Paragraph>
                          </li>
                          <li>
                            ...
                            <Paragraph className="reduced-margin-top">
                              <span className="italic-underline">Purpose:</span>{' '}
                              These Cookies identify if Users have accepted the
                              use of Cookies.
                            </Paragraph>
                          </li>
                          <li>
                            ...
                            <Paragraph className="reduced-margin-top">
                              ...
                              preference. The larger purpose of these Cookies is
            ...
            <li>
              <SubHeading>
                For what do We use Your Personal Information and with whom do We
                share it?
              </SubHeading>
              <Paragraph>
                <ol>
                  <li>
                    ...
                    Platform is used only for lawful purposes and with an aim to
                    provide You the services. We do not sell or rent this
                    information to anyone nor do We share Your information with
                    any third party, unless otherwise provided under the
                  ...
                  <li>
                    ...
                    <ol>
                      <li>
                        ...
                        We use Your Personal Information, which may include Your
                        name, email ID, payment details etc., to ensure that You
                        and Your fellow travellers, if any, can complete and
                        secure a booking.
                      </li>
                      <li>
                        <span className="italic-underline">
                        ...
                        We do run marketing and promotional campaigns along with
                        the Service Providers and/or any other third parties and
                        We may use Personal Information, which may include name,
                        email ID, contact details etc., to ensure that requisite
                        benefits are passed on to You under such marketing and
                        promotional campaigns. Additionally, You may also
                        receive emails/notifications regarding marketing
                        campaigns, newsletters, reward programs and exclusive
                      ...
                      <li>
                        ...
                        are not limited to –
                        <ul>
                          <li>Provide, maintain and improvise Our services;</li>
                          <li>
                            Communicate with You for different purposes
                            including but not limited to keep You informed about
                            any updates around the booking made by You;
                          </li>
                  ...
                  <li>
                    ...
                    <ol>
                      <li>
                        ...
                        Personal Information with Third Party Vendors to monitor
                      ...
                      <li>
                        ...
                        Personal Information required in each case depending on
                        the selected payment method. Similarly, some of Your
                        Personal Information will be processed by parties who
                        assist in the processing of the payment including but
                        not limited to payment gateways, banking partners or any
                        other third party that may be engaged in such process.{' '}
                      </li>
                      <li>
                        <b>With service providers/business partners:</b> We may
                      ...
                      <li>
                        ...
                        third-party/social media platforms, such information may
                        be viewed by all users and may be publicly distributed
                        outside. If You interact with other Users or register
                        through third-party/social media platforms, Your
                        contacts on the third-party/social media platforms may
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            By law, by court order, by any enforcement authority
                            or in reference to any legal purposes;
                          </li>
                          <li>For audit and compliance purposes;</li>
                          <li>
                            For any other purpose that is in the larger interest
                            of You as a User.
                          </li>
                        </ul>
                      </li>
                  ...
                  <li>
                    Some of the third parties/vendors may choose to retain some
                    of Your Personal Information. However, that is for limited
                    purposes to provide You with services in compliance with the
                    Terms of Use. Please note that these third parties/vendors
                    have informed us that they are compliant with respective
                    privacy laws and have a detailed privacy policy in place. If
                    You want to know about these third parties/vendors you can
                    raise a request by writing on{' '}
                    <a href="mailto:privacy@headout.com">privacy@headout.com</a>{' '}
              ...
              <Paragraph>
                <ol>
                  <li>
                    ...
                    or discussions on the Platform or any social media platform
                    is collectively referred to as,{' '}
                    <b>&quot;User Content&quot;</b>. User shall be solely
                    responsible for the authenticity and correctness of all the
                    User Content.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    using their personal social media accounts such as Facebook,
                    Google etc. In such a scenario, We may capture some of Your
                    Personal Information from Your social media account like
                  ...
                  <li>
                    ...
                    have made with those social media platforms will also apply.
                  </li>
                </ol>
              </Paragraph>
            </li>
