...
import { isPrivateTransferSearchFormComplete } from '../SharedTransferSearch/utils';
import {
...
export const PrivateTransferSearch = ({
  isMobile,
  uid,
}: {
  isMobile: boolean;
  ...
  const handlePaxFieldClick = () => {
    ...
    trackEvent({
      eventName: ANALYTICS_EVENTS.AIRPORT_TRANSFERS.SEARCH_FILTER_CLICKED,
      [ANALYTICS_PROPERTIES.AIRPORT_TRANSFERS.FILTER_NAME]: 'Pax',
    });
  };
  ...
  const handleSearchButtonClick = () => {
    ...
    trackEvent({
      ...
      [ANALYTICS_PROPERTIES.SECTION]: 'Private Search',
    });
