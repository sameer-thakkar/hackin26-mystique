...
import { TPinnedCardProps } from 'components/MicrositeV2/EntertainmentMBLandingPageV2/BannerV2PinnedCard/interface';
import {
  Container,
  Gradient,
  ProductDetails,
  ...
  Wrapper,
  YourPickHeader,
} from 'components/MicrositeV2/EntertainmentMBLandingPageV2/BannerV2PinnedCard/style';
  ...
  return (
    <Container ref={pinnedCard} isVerticalImageUrlPresent={!!verticalImageUrl}>
      <Conditional if={isMobile}>
        <h2>{strings.ENTERTAINMENT_MB_LANDING_PAGE.YOUR_PICK}</h2>
      </Conditional>
      <Conditional if={!isMobile}>
        <Image
