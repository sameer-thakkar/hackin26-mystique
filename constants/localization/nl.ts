        ...
        content: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: "Sociale-mediaplatformen verwijzen naar platformen zoals Facebook, Instagram etc. die worden gebruikt om met het Bedrijf te communiceren in verschillende scenario's en/of om een inlogaccount aan te maken op het Headout-platform.",
              },
              {
              ...
              },
              {
                ...
                subItems: [
                  ...
                  },
                  {
                    ...
                    bulletPoints: [
                      'Noodzakelijke/essentiële cookies\nType: Sessiecookies\nDoel: Deze cookies zijn essentieel om toegang te krijgen tot verschillende secties van het Headout-platform en als deze niet toegestaan zijn, is het mogelijk dat u geen toegang krijgt tot de beschikbare diensten op het Headout-platform. Deze cookies helpen ons verder om uw identiteit te verifiëren en frauduleuze activiteiten op het Headout-platform te voorkomen.',
                      'Cookiebeleid/Kennisgeving acceptatie van cookies\nType: Persistente cookies\nDoel: Deze cookies identificeren of u het gebruik van cookies heeft geaccepteerd.',
                      'Functionele cookies\nType: Persistente cookies\nDoel: Met deze cookies kunnen wij de keuzes onthouden die u maakt wanneer u het Headout-platform gebruikt, zoals het onthouden van u inloggegevens of taalvoorkeur. Het grotere doel van deze cookies is om u een meer gepersonaliseerde ervaring te bieden telkens wanneer u het Headout-platform gebruikt.',
                    ],
                  },
                ],
              },
            ...
            items: [
              ...
              },
              {
                ...
                subItems: [
                  ...
                  {
                    text: 'Klantenservice: Headout gebruikt de door de Service Providers verstrekte informatie (die Persoonsgegevens kan bevatten) ook om allerlei ondersteunende diensten te verlenen. Dit kan omvatten, maar is niet beperkt tot, het reageren op verzoeken, vragen of zorgen van Service Providers of Gebruikers.',
                  },
                  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Als u als minderjarige een Boeking wilt maken op het Platform, bent u verplicht om ervoor te zorgen dat een dergelijke Boeking alleen wordt gemaakt door een persoon die meerderjarig is (ouders, broers of zussen of wettelijke voogd).',
          'Uw gebruik van de Website en het uitvoeren van Boekingen is alleen toegestaan voor persoonlijk, niet-commercieel gebruik en/of om legitieme verzoeken te doen om een Boeking te maken van de ervaringen die op de Website worden aangeboden. U stemt ermee in de Website niet te gebruiken om speculatieve, valse of frauduleuze verzoeken voor Boekingen te doen. In geval, indien Headout kennis krijgt van een dergelijk geval, zal Headout het recht hebben om dergelijke Boekingen te annuleren en de Gebruiker zal geen recht hebben om enige schadevergoeding van Headout te vorderen.',
      ...
      },
      {
        ...
        items: [
          'De Inhoud van de Website, evenals de infrastructuur die wordt gebruikt om dergelijke Inhoud van de Website te leveren, is ofwel ons eigendom of wordt ons toegekend onder een geldige licentie. U stemt ermee in de Inhoud van de Website, of producten of diensten die van of via de Website zijn verkregen, niet anderszins te wijzigen, kopiëren, distribueren, verzenden, weergeven, uitvoeren, reproduceren, publiceren, in licentie te geven, er afgeleide werken van te maken, over te dragen of te verkopen of door te verkopen. Elk ander gebruik van de Website-inhoud, producten en/of diensten vereist de voorafgaande schriftelijke toestemming van Headout.',
          {
            ...
            subItems: [
              'de Website of de inhoud van de Website te gebruiken voor commerciële of onwettige doeleinden;',
              'de inhoud van de Website te benaderen, te controleren of te kopiëren met behulp van een robot; spider, scraper of ander geautomatiseerd middel of enig handmatig proces om de Website of inhoud van de Website te benaderen, te scrapen, te indexeren, op te halen of anderszins te gebruiken voor enig doel zonder onze uitdrukkelijke schriftelijke toestemming;',
      ...
      },
      {
        ...
        items: [
          ...
          'U kunt merken dat sommige websites van derden links beschikbaar hebben op de Website van Headout. Het openen van dergelijke links door de Gebruiker is op eigen risico en Headout kan niet aansprakelijk worden gesteld in geval van verlies of schade geleden door de toegang tot dergelijke links en het delen van persoonlijke informatie op dergelijke links. Gebruikers zijn gebonden aan de gebruiksvoorwaarden en het privacybeleid van dergelijke websites van derden en worden geadviseerd om dergelijke voorwaarden na te lezen.',
        ],
      },
      {
