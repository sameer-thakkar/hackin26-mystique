---
name: mirrord-test
description: Run any service with mirrord against a Kubernetes ODE environment, auto-detect or create configs, start the app, and test API changes end-to-end.
