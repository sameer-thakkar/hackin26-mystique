...
export default class GroupBooking extends Component<any, any> {
    ...
    handleReactSelectChange = (value, state) =>
                ...
                <div className="popup-wrapper">
                    <div className="popup-title">
                        ...
                        <small className="hide-mobi">
                            Regardless of the size of group, we offer an
                    ...
                    <div className="hide-desk group-text">
                        <span>
                            Regardless of the size of group, we offer an
                            exceptional level of service and best prices for
                            each of our Tours at Vatican.
                        </span>
                        ...
                        <div className="success wrapx">
                            <section className="main-area wrapper">
                                ...
                                <div className="info-text">
                                    We've received your group tickets request.
                                    Our team will get in touch with you soon to
                                    help you complete your reservation
                                </div>
                                <div className="info-text">Or</div>
                                <div className="info-text">
                                    Alternatively, speak directly to our
                                    reservations team to get the best deals and
                                    make your booking process as simple as
