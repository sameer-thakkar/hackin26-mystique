const en = {
  ...
  SAFE_EXPERIENCE: {
    ...
    MODAL: {
      ...
      DETAILS: {
        ...
        SAFETY_CONTACTLESS: {
          HEADING: 'Contactless entry with zero hassles ',
          DESCRIPTION:
            "It's 2020 and you should be able to enjoy your experience without having to touch anything or anyone. And you can.",
        },
      },
      BADGE_DESCRIPTION:
  ...
  SHOWPAGE: {
    ...
    // Remove this 👇 after 5-9-22
    LIMITED_CASHBACK_OFFER: {
      OFFER_TITLE: 'Get 10% Cashback On Your Tickets for London Theatre Week!',
      OFFER_SUBTEXT:
        'Hurry and book now to avail this exciting offer valid till September 4, 2022.',
    },
  },
