...
const sv: TDictionary = {
  ...
  COOKIE_CONSENT: {
    ...
    DESCRIPTION: `*   Cookies är små filer som placeras på din dator, mobila enhet eller någon annan enhet av webbplatsen/plattformen och som innehåller information om din webbhistorik och många andra användningsområden.
...
`,
  ...
  DESCRIPTORS: {
    ...
    HOTEL_PICKUP: 'Upphämtning tillgänglig',
    ...
    TRANSFERS: 'Transport tillgänglig',
    ...
    MODAL: {
      DETAILS: {
        ...
        PREVENTIVE_SAFETY_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Skyddsutrustning såsom masker är obligatoriska för att få tillträde till lokalen</li>
        ...
        SOCIAL_DISTANCING_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Lokalen har omformats för att minimera kontakten mellan alla i publiken</li>
...
`,
  ...
  INVENTORY_UNAVAILABLE: {
    ...
    MESSAGE: `Ursäkta! Alla upplevelser på detta datum är antingen slutsålda eller
  ...
  ITINERARY: {
    ...
    VIEW_DETAILS: 'Visa information',
    VIEW_ALL_STOPS: 'Visa alla stopp',
  ...
  GROUP_BOOKING: {
    TITLE: 'Vill du boka för {0} personer eller fler?',
    SUBTEXT:
