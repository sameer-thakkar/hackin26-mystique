...
export const OLYMPIC_BANNER_UID = [
  'airport-transfers.tickets-paris.fr',
  'amboise-castle.loirevalley-tickets.com',
  'amboise.billets-chateaux-de-la-loire.fr',
  'arc-de-triomphe.tickets-paris.fr',
  'azay-le-rideau-castle.loirevalley-tickets.com',
  'beauvais-airport-transfers.tickets-paris.fr',
  'blois-castle.loirevalley-tickets.com',
  'catacombs.tickets-paris.fr',
  'centre-pompidou.tickets-paris.fr',
  'chambord-castle.loirevalley-tickets.com',
  'chambord.billets-chateaux-de-la-loire.fr',
  'chateau-de-chantilly.tickets-paris.fr',
  'chateau-de-fontainebleau.tickets-paris.fr',
  'chaumont-castle.loirevalley-tickets.com',
  'chaumont-sur-loire.billets-chateaux-de-la-loire.fr',
  'chenonceau-castle.loirevalley-tickets.com',
  'chenonceau.billets-chateaux-de-la-loire.fr',
  'conciergerie.tickets-paris.fr',
  'crazy-horse.cabaret-paris.com',
  'cruises.nice-tickets.com',
  'd-day-tours.normandy-tours.com',
  'day-trips.nice-tickets.com',
  'disneyland-paris.tickets-paris.fr',
  'fondation-louis-vuitton.tickets-paris.fr',
  'futuroscope.loirevalley-tickets.com',
  'hotel-de-la-marine.tickets-paris.fr',
  'lavender-tour.provence-tickets.com',
  'louvremuseum.tickets-paris.fr',
  'mont-saint-michel.normandy-tours.com',
  'montmartre.tickets-paris.fr',
  'moulin-rouge.cabaret-paris.com',
  'mucem.marseille-billets.fr',
  'musee-de-larmee.tickets-paris.fr',
  'musee-grevin.tickets-paris.fr',
  'musee-national-picasso.tickets-paris.fr',
  'musee-rodin.tickets-paris.fr',
  'nausicaa.normandy-tours.com',
  'oceanographic-museum.nice-tickets.com',
  'opera.tickets-paris.fr',
  'orangerie.tickets-paris.fr',
  'orsay-museum.tickets-paris.fr',
  'pantheon.tickets-paris.fr',
  'paradis-latin.cabaret-paris.com',
  'parcasterix.tickets-paris.fr',
  'paris-beauvais.airporttransfertickets.com',
  'puy-du-fou.loirevalley-tickets.com',
  'saint-denis-basilique.tickets-paris.fr',
  'sainte-chapelle.tickets-paris.fr',
  'science-and-industry-museum.tickets-paris.fr',
  'tour-montparnasse.tickets-paris.fr',
  'wine-tours.provence-tickets.com',
  'www.billets-carcassonne.fr',
  'www.billetseiffel.fr',
  'www.cabaret-paris.com',
  'www.cabaret-paris.com.crazy-horse-tickets',
  'www.cabaret-paris.com.moulin-rouge',
  'www.cabaret-paris.com.paradis-latin-tickets',
  'www.eiffeltickets.com',
  'www.givernymonettickets.com',
  'www.hop-on-hop-off-tickets.com.marseille-bus-tours',
  'www.hop-on-hop-off-tickets.com.paris-bus-tours',
  'www.hop-on-hop-off-tickets.com.paris-bus-tours.paris-batobus',
  'www.hop-on-hop-off-tickets.com.paris-bus-tours.paris-big-bus',
  'www.loirevalley-tickets.com',
  'www.loirevalley-tickets.com.chateau-de-chambord',
  'www.loirevalley-tickets.com.chateau-de-chenonceau',
  'www.marineland-antibes-tickets.com',
  'www.normandy-tours.com.mont-saint-michel',
  'www.seine-river-cruises.com',
  'www.seine-river-cruises.com.dinner-cruises',
  'www.seine-river-cruises.com.lunch-cruises',
  'www.seine-river-cruises.com.paris-boat-tours',
  'www.tickets-paris.fr',
  'www.tickets-paris.fr.arc-de-triomphe-tickets',
  'www.tickets-paris.fr.beauvais-airport-transfers',
  'www.tickets-paris.fr.conciergerie-tickets',
  'www.tickets-paris.fr.day-trips-from-paris',
  'www.tickets-paris.fr.disneyland-paris',
  'www.tickets-paris.fr.grevin-museum-tickets',
  'www.tickets-paris.fr.hotel-de-la-marine-tickets',
  'www.tickets-paris.fr.louvre-museum',
  'www.tickets-paris.fr.musee-dorsay',
  'www.tickets-paris.fr.pantheon-tickets',
  'www.tickets-paris.fr.sainte-chapelle-tickets',
  'www.tickets-paris.fr.transportation.airport-transfers',
  'www.versailles-palace-tickets.com',
];
