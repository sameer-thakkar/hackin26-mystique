...
const da: TDictionary = {
  ...
  COOKIE_CONSENT: {
    ...
    DESCRIPTION: `*   Cookies er små filer, som webstedet/platformen placerer på din computer, mobilenhed eller enhver anden elektronisk enhed, og som blandt andet indeholder oplysninger om din browserhistorik.
...
`,
  ...
  DESCRIPTORS: {
    ...
    HOTEL_PICKUP: 'Afhentning tilgængelig',
    ...
    MODAL: {
      DETAILS: {
        ...
        PREVENTIVE_SAFETY_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Beskyttelsesudstyr som f.eks. mundbind er obligatorisk for at komme ind på stedet</li>
        ...
        SOCIAL_DISTANCING_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Stedet er blevet redesignet for at minimere kontakten mellem alle tilskuere</li>
...
`,
  ...
  INVENTORY_UNAVAILABLE: {
    ...
    MESSAGE: `Vi beklager. Alle oplevelser på denne dato er enten udsolgt eller
  ...
  ITINERARY: {
    ...
    DESCRIPTORS: {
      ...
      ATTRACTION_COUNT: '{0} seværdighed',
      ACTIVITIES_COUNT: '{0} aktiviteter',
      ACTIVITY_COUNT: '{0} aktivitet',
  ...
  LTT_BROADWAY_BANNER: {
    LTT: {
      BANNER_TITLE: 'Oplev det bedste fra West End',
      BANNER_SUBTEXT:
        'Godkendte billetter, gode pladser, gode tilbud og pålidelige anmeldelser',
    },
    BROADWAY: {
      BANNER_TITLE: 'Oplev det bedste fra Broadway',
      BANNER_SUBTEXT:
        'Godkendte billetter, gode pladser, gode tilbud og pålidelige anmeldelser',
    },
  },
