const pt = {
  ...
  SAFE_EXPERIENCE: {
    ...
    MODAL: {
      ...
      DETAILS: {
        ...
        SAFETY_CONTACTLESS: {
          HEADING: 'Entrada sem contato e sem contratempos ',
          DESCRIPTION:
  ...
  DISCOUNTED_FUTURES: {
    ...
    FAQ_QUESTIONS: {
      ...
      LIMITS: {
        ...
        ANSWER: [
          ...
          'Cashback ou créditos em sua carteira não podem ser usados para adquirir uma reserva aberta.',
    ...
    IMAGES_SECTION: {
      HEADING: 'O mundo está esperando - vamos explorá-lo de novo em breve',
    },
    BOOKING_MODAL: {
      BOOK_NOW_PITCH:
  ...
  HOURS: 'h',
  MINUTES: 'min',
  REVIEW_COUNT: '{0} comentários',
  REVIEWS: 'Comentários',
  SHOW_MORE_REVIEWS: 'Ver mais comentários',
  SHOW_LESS_REVIEWS: 'Mostrar menos avaliações',
};
