const fr = {
    ...
    MODAL: {
      ...
      DETAILS: {
        ...
        SAFETY_CONTACTLESS: {
          ...
          DESCRIPTION:
            "Nous sommes en 2020 et vous devriez pouvoir profiter de votre expérience sans avoir à toucher quoi que ce soit ou qui que ce soit. Et c'est le cas.",
        },
      },
      BADGE_DESCRIPTION:
  ...
  DISCOUNTED_FUTURES: {
    HEADING:
      "Réservez dès aujourd'hui tout en profitant de réductions et partez en voyage quand bon vous semble",
    DESCRIPTION:
      "Pour une période limitée, vous pouvez réserver un **billet non daté** pour certaines de vos expériences préférées, valable jusqu'au 31 décembre 2021, et qui vous permettra de réaliser des économies importantes, de planifier vos prochaines vacances avec plus de souplesse et de passer un moment inoubliable.",
    SHORT_DESCRIPTION:
      "Achetez des bons à prix réduit et profitez-en jusqu'au <date>. Économisez de l'argent et soutenez l'industrie du voyage !",
    BANNER: {
      HEADING_LINE1:
        "Vous n'êtes pas sûr(e) de la date de votre prochain voyage ?",
      HEADING_LINE2:
        "Réservez un billet non daté et profitez d'une plus grande flexibilité et de réductions !",
      DESCRIPTION_LINE1: "Économisez jusqu'à 50 %",
      DESCRIPTION_LINE2:
        "Valable pour un séjour à n'importe quel moment entre le <cooldownDate> et le 31 décembre 2021.",
    },
    FLAG_TEXT: 'Réserver pour plus tard',
    ...
    FAQ_QUESTIONS: {
      ...
      LIMITS: {
        QUESTION:
          "Y a-t-il des restrictions ou des limites à l'achat de billets non datés ?",
        ANSWER: [
          "Les codes de réduction ou de coupon ne sont pas applicables lors de l'achat de billets non datés.",
          'Les remboursements ou les crédits dans votre portefeuille <mbName> ne peuvent pas être utilisés pour réserver un billet non daté.',
          'Une fois que vous avez échangé le billet non daté en sélectionnant une date pour votre visite, vous ne pouvez plus modifier ou annuler la réservation.',
          'Vous pouvez effectuer un maximum de 2 réservations par personne et par expérience pendant la durée de cette action.',
        ],
      },
      EXERCISE: {
    ...
    HOW_IT_WORKS: {
      ...
      VOUCHER: {
        ...
        SUB_TEXT:
          "Une fois vos projets de voyage confirmés, échangez votre billet non daté en sélectionnant la date et l'heure auxquelles vous souhaitez profiter de l'expérience. Vous pouvez utiliser votre billet du <cooldownDate> au 31 décembre 2021.",
      },
      REDEEM: {
        HEADING: 'Profitez de votre séjour !',
        SUB_TEXT: 'Ça y est, tout est prêt. Passez de bonnes vacances !',
      },
    },
    PITCH: {
      GO_ANYTIME: {
        HEADING: 'Voyagez quand bon vous semble',
        SUB_TEXT:
          "Nous savons combien il est difficile pour l'instant de se prononcer sur ses projets de voyage et c'est pourquoi vous pouvez utiliser ces bons jusqu'au <date>, ce qui vous laisse tout le temps nécessaire pour prévoir vos prochaines vacances.",
      },
      SAVE_MONEY: {
        HEADING: 'Faites des économies',
        SUB_TEXT:
          "Les réductions avantageuses que vous voyez ici vous permettent d'économiser de l'argent lors de votre prochain voyage, au cas où vous auriez besoin d'une autre raison pour vous convraince à partir bientôt en voyage.",
      },
      BUCKET_LIST: {
        HEADING: 'Annulation flexible',
        SUB_TEXT:
          "Si vous n'avez pas échangé votre bon, vous pouvez annuler votre réservation à tout moment et vous faire rembourser en intégralité. Nous savons que changer de plan pour un voyage peut être source de stress. Voilà donc une chose en moins dont vous ne devez pas vous soucier.",
      },
    },
    IMAGES_SECTION: {
      HEADING: 'Le monde nous attend, repartons bientôt à sa découverte',
    },
    BOOKING_MODAL: {
      BOOK_NOW_PITCH:
        'Sélectionnez une date ou un créneau horaire pour réserver votre expérience.',
      SELECT_DATE: 'Sélectionnez une date',
      GO_LATER_HEADING: 'Billet non daté',
      BOOK_NOW_HEADING: 'Billet horodaté',
      GO_LATER_PITCH:
        "Réservez cette expérience à un prix réduit et choisissez votre date de visite plus tard, en toute liberté. Votre bon peut être échangé pour n'importe quelle date de voyage entre le <stDate> et le <edDate>.",
      GET_THIS: 'Réserver',
  ...
  SHOW_PAGE: {
    ...
    QUESTION: 'Q-',
    ANSWER: 'R-',
    LISTICLE_SHOW_SUMMARY: 'Résumé du spectacle',
    LISTICLE_SHOW_WHY_WATCH: 'Pourquoi faut-il voir le spectacle',
