...
const ro: TDictionary = {
  ...
  COOKIE_CONSENT: {
    ...
    DESCRIPTION: `*   Modulele cookie sunt fișiere de mici dimensiuni plasate pe computerul, dispozitivul mobil sau orice alt dispozitiv al dumneavoastră de către site-ul web/platformă, care conțin detaliile istoricului navigării dumneavoastră între alte utilizări.
...
`,
  ...
  DESCRIPTORS: {
    ...
    HOTEL_PICKUP: 'Preluare disponibilă',
    ...
    TRANSFERS: 'Transferuri disponibile',
    ...
    MODAL: {
      DETAILS: {
        ...
        PREVENTIVE_SAFETY_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Echipamentele de protecție, cum ar fi măștile, sunt obligatorii pentru a intra în incintă</li>
        ...
        SOCIAL_DISTANCING_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Locul de desfășurare a fost reproiectat pentru a minimiza contactul între toți spectatorii</li>
  ...
  INVENTORY_UNAVAILABLE: {
    ...
    MESSAGE: `Ne pare rău! Toate experiențele pentru această dată sunt fie epuizate, fie
  ...
  ITINERARY: {
    ...
    VIEW_DETAILS: 'Vedeți detalii',
    VIEW_ALL_STOPS: 'Vedeți toate stațiile',
    ...
    DESCRIPTORS: {
      ...
      ATTRACTION_COUNT: '{0} atracție',
      ACTIVITIES_COUNT: '{0} activități',
      ACTIVITY_COUNT: '{0} activitate',
  ...
  TERMS_OF_USE_CONTENT: {
    linkText: 'Prior Terms of Use',
    title: 'Headout: Terms of Use',
    introduction:
      'These Terms of Use will be effective from the Last Updated date mentioned above ("Terms of Use").',
    lastUpdated: '26th March 2026',
    ...
    sections: [
      ...
      {
        title: 'Headout\u2019s Digital Accessibility Statement',
        items: [
          {
            text: 'Our Policy & Commitment- At Headout, we are committed to accessibility, diversity, and inclusion. As part of that commitment, we are making efforts to ensure that Headout\u2019s digital properties are accessible to all individuals, regardless of ability. In doing so, Headout has a goal to be compliant of applicable accessibility standards included in the W3C\u2019s WCAG version 2.2 level AA guidelines.',
            subItems: [],
          },
          {
            text: 'Digital Accessibility Statement',
            subItems: [
              'We are always committed to continual improvement and to the best of our ability ensure that our websites and online services are accessible for all and are committed to following the W3C Web Content Accessibility Guidelines and other applicable web accessibility laws.',
              'To ensure this, we onboarded with Level Access to leverage their digital accessibility platform and 25 years of experience to sustain conformance to accessibility standards.\u00a0 Their digital accessibility platform is used to evaluate our digital properties in accordance with best practices and is supported by a diverse team of accessibility professionals, including users with disabilities.',
              'Through this partnership, Headout continues to develop its digital accessibility program and capabilities so that at Headout we are designing, developing, and testing our websites and online services for conformance to accessibility standards.',
            ],
          },
          {
            text: 'Contact- We want to hear from You. If you would like further information about Headout\u2019s accessibility efforts, have other accessibility questions or feedback, or encounter accessibility barriers on our digital properties, please contact: support@headout.com',
            subItems: [],
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          "HEADOUT'S AGGREGATE LIABILITY UNDER THESE TERMS OF USE SHALL NOT EXCEED THE AMOUNT PAID BY YOU TO HEADOUT IN CONNECTION WITH THE BOOKING WHICH FORMS THE SUBJECT MATTER OF A CLAIM HEREUNDER. THE DISCLAIMERS AND LIMITATIONS IN THIS CLAUSE WILL APPLY NOTWITHSTANDING ANY FAILURE OF THE ESSENTIAL PURPOSE OF ANY LIMITED REMEDY AND TO THE MAXIMUM EXTENT PERMITTED UNDER APPLICABLE LAW.",
          {
            text: 'BY ACCESSING OR USING DEX, YOU UNDERSTAND THAT DEX IS NOT A LICENSED TOUR GUIDE/TRAVEL AGENT AND YOU ACKNOWLEDGE AND ACCEPT THESE LIMITATIONS:',
            subItems: [
              'DEX IS AN AI-POWERED DIGITAL AUDIO GUIDE DESIGNED TO ENHANCE EXPLORATION THROUGH STORYTELLING, HISTORICAL CONTEXT, AND THEMED NARRATION. DEX MAY FEATURE FICTIONAL CHARACTERS, ROLE-PLAY, DRAMATIZED DIALOGUE, THEMED NARRATION, OR CREATIVE STORYTELLING. SUCH ELEMENTS ARE USED SOLELY FOR IMMERSIVE AND ENTERTAINMENT PURPOSES AND SHOULD NOT BE INTERPRETED AS FACTUAL, HISTORICAL, OR OFFICIAL REPRESENTATIONS.',
              'HISTORICAL FACTS, EVENTS, AND CULTURAL INTERPRETATIONS ARE BASED ON AVAILABLE SOURCES AND CREATIVE SYNTHESIS AND MAY VARY ACROSS REFERENCES. DEX DOES NOT CLAIM ACADEMIC ACCURACY. THE EXPERIENCE IS PRESENTED IN GOOD FAITH AND IS NOT INTENDED TO HARM, OFFEND, OR MISREPRESENT ANY INDIVIDUAL, COMMUNITY, BELIEF, RELIGION, CULTURE, OR GROUP, NOR TO IMPLY ENDORSEMENT OR CRITICISM OF ANY VIEWPOINT.',
              'DEX DOES NOT ACCOUNT FOR REAL-TIME CONDITIONS SUCH AS CROWD LEVELS, WEATHER, CONSTRUCTION, ACCESSIBILITY CHANGES, CLOSURES, OR EMERGENCIES. USERS MUST RELY ON ON-SITE STAFF, OFFICIAL SIGNAGE, AND THEIR OWN JUDGMENT AT ALL TIMES.',
              'ANY THEMES INVOLVING ADVENTURE, MYSTERY, SIMULATION, OR HYPOTHETICAL SCENARIOS ARE FICTIONAL AND INTENDED SOLELY FOR ENGAGEMENT AND ENTERTAINMENT. THEY DO NOT REFLECT ACTUAL RISKS, EVENTS, OR OPERATIONAL REALITIES OF THE LOCATION.',
              'WHILE REASONABLE EFFORTS ARE MADE TO ENSURE ACCURACY, COMPLETENESS, AND RELIABILITY, THE CONTENT IS GENERATED USING AI-BASED AUTOMATED SYSTEMS AND MAY CONTAIN ERRORS, OMISSIONS, SIMPLIFICATIONS, DRAMATIZATIONS, OR OUTDATED INFORMATION. NO REPRESENTATIONS OR WARRANTIES ARE MADE REGARDING FACTUAL ACCURACY, REAL-TIME APPLICABILITY, OR SUITABILITY FOR ANY PARTICULAR PURPOSE, AND USERS RELY ON THE CONTENT AT THEIR OWN RISK. USERS ARE SOLELY RESPONSIBLE FOR THEIR PERSONAL SAFETY, SITUATIONAL AWARENESS, CONDUCT, AND COMPLIANCE WITH ALL APPLICABLE LAWS, VENUE RULES, SIGNAGE, AND INSTRUCTIONS FROM AUTHORIZED PERSONNEL.',
              'DEX MAY BE ACCESSED BY MINORS; PARENTS, LEGAL GUARDIANS, OR ACCOMPANYING ADULTS ARE RESPONSIBLE FOR SUPERVISING CHILDREN AT ALL TIMES. ACCESSIBILITY NEEDS VARY, AND DEX MAY NOT MEET ALL PHYSICAL, SENSORY, COGNITIVE, OR MOBILITY REQUIREMENTS. DEX DOES NOT REPLACE VENUE-PROVIDED SUPERVISION, ACCESSIBILITY SERVICES, ACCOMMODATIONS, OR ON-SITE SUPPORT.',
              'DEX IS DESIGNED WITH INCLUSIVITY IN MIND; HOWEVER, ACCESSIBILITY NEEDS AND ABILITIES VARY WIDELY BY INDIVIDUAL. DEX MAY NOT FULLY ADDRESS ALL PHYSICAL, SENSORY, COGNITIVE, MOBILITY, OR COMMUNICATION REQUIREMENTS AND DOES NOT REPLACE OFFICIAL ACCESSIBILITY SERVICES, ACCOMMODATIONS, OR ASSISTANCE PROVIDED BY THE VENUE OR EVENT OPERATOR. CONTENT IS PRESENTED FOR GENERAL INFORMATIONAL PURPOSES ONLY AND MAY NOT REFLECT REAL-TIME ACCESSIBILITY CONDITIONS OR LEGAL ACCESSIBILITY STANDARDS IN ALL JURISDICTIONS. USERS SHOULD RELY ON VENUE STAFF, ON-SITE FACILITIES, AND OFFICIAL ASSISTANCE FOR ACCESSIBILITY-RELATED SUPPORT, ALTERNATIVE FORMATS, ACTIONABLE ACCOMMODATIONS, SAFETY GUIDANCE, AND EMERGENCY NEEDS.',
              'TO THE MAXIMUM EXTENT PERMITTED BY LAW, NO LIABILITY IS ACCEPTED FOR ANY LOSS, INJURY, DAMAGE, OR INCONVENIENCE ARISING FROM USE OF OR RELIANCE ON THIS EXPERIENCE OR DEX.',
            ],
          },
        ],
      },
        ...
        content: [
          {
            ...
            items: [
              ...
              {
                text: 'This Policy, describes inter alia Headout\'s procedures for the collection, processing, disclosure and protection of Your Personal Information when You i.) as a user access our website www.headout.com or its mobile application or the Headout Dex mobile application ("Platform"), or ii.) as Supply Partner access https://hub.headout.com/ ("Headout Hub") or iii.) as an Affiliate Partner access https://partner.headout.com/affiliate/ ("Headout Partner Platform") or iv.) as Creator Partner access our creator site ("Creator Platform") [Platform, Supply Partner Platform, Affiliate Partner Platform and Creator Platform shall together be referred as "Headout Platform"]. This Policy is also intended to guide You about Your privacy rights. Under this Policy, we have also suggested how You can contact Us in case You have any issues/doubts.',
              },
              {
                text: 'Please note that we use Your Personal Information to inter alia provide You with the service(s) available on the Headout Platform in the best possible manner, improvise the overall usage of the Headout Platform and to carry out other processing activities outlined in this Policy.',
              },
        ...
        content: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                subItems: [
                  {
                    text: 'In addition to the information described above, certain features of the Headout Platform may require access to specific functionalities of Your Device. These permissions are optional and are accessed only with Your explicit consent. You may manage or revoke such permissions at any time through Your device settings.',
                  },
                  {
                    text: 'Microphone (including audio recording)- Access to the microphone (including audio recording functionality) is required solely to enable interactive audio-guide experiences, provide voice-based navigation or assistance; and record audio where such recording is required for delivering or enhancing the relevant service. If audio is recorded, such recordings will be stored and processed to fulfill the requested service.',
                  },
                  {
                    text: 'Camera, Photo gallery/Media- Access to your camera is required solely to allow You to share content related to an experience, where such functionality is offered on the Headout Platform or to support augmented reality or other visual-content features, to enhance Your experience or fulfill the requested service. Such images or videos shall be processed only to provide the requested features and/or to improvise Headout Services.',
                  },
                  {
                    text: 'Location- We may collect precise or approximate location data in order to: (a) show You relevant available experiences, services, or events near Your current location; (b) enable location-based audio and information features; (c) enhance Your overall experience and (d) improvise Headout Services.',
                  },
                ],
              },
              {
        ...
        content: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                subItems: [
                  {
                    text: "For booking purposes: We use Your Personal Information, which may include Your and Your fellow travelers' name, email ID, payment details etc., to ensure that all bookings made on Headout Platform are concluded and enjoyed in satisfactory manner.",
                  },
                  {
                    text: 'For marketing purposes: We do run marketing and promotional campaigns along with the Service Providers and/or any other third parties and We may use Personal Information, which may include name, email ID, contact details, etc., to ensure that requisite benefits are passed on to Users under such marketing and promotional campaigns. Additionally, Users may also receive emails/notifications regarding marketing campaigns, newsletters, reward programs, and exclusive promotions offering special deals. Under this section, we shall also use the content submitted by the Content Creator for running promotional activities for Headout. You may opt out of marketing communications at any time by using the “unsubscribe” link in the email.',
                  },
                  {
                    text: 'Customer service: Headout also uses the information provided by the Service Providers (which may include personal data) to provide all sorts of support services. This may include but is not limited to, responding to requests, questions, or concerns from Service Providers or Users.',
                  },
                  ...
                  },
                  {
                    ...
                    bulletPoints: [
                      'Provide, maintain, and improvise Our services;',
                      'To personalize or enhance Your experience;',
                      'Communicate with You for different purposes including but not limited to keeping You informed about any updates with regards to the services availed on the Headout Platform;',
                      'Any changes made on the Headout Platform;',
                      'For customer service purposes;',
                      'For seeking reviews of services;',
        ...
        content: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                subItems: [
                  {
                    text: 'Right to Access Information- You have the right to request, at any time, a complete summary of the Personal Information we hold about You.',
                  },
                  {
                    text: 'Right to Correct Inaccurate Data- If You believe that any Personal Information We maintain about You is incorrect or incomplete, You may request its prompt correction.',
                  },
                  {
                    text: 'Right to Erasure- You are entitled to ask Us to delete your personal data when it is no longer necessary for its original purpose, has been unlawfully processed, or where an applicable legal requirement for erasure exists.',
                  },
                  {
                    text: 'Right to Restrict Processing- You may request that We limit how We process your personal data under the conditions specified under relevant law. This right can be invoked, for example, if You contest the accuracy of Your data or if You need it preserved solely for the purpose of establishing, exercising, or defending legal claims.',
                  },
                  {
                    text: 'Right to Data Portability- You have the right to receive the Personal Information You have provided to Us in a structured, commonly used, machine-readable format, enabling You to transfer this data to another service provider.',
                  },
                  {
                    text: 'Right to Object- You may object, at any time and on grounds specific to Your situation, to the processing of Your personal data. In such cases, We will halt the processing of Your data unless We can demonstrate compelling legitimate reasons for its continued use or that it is necessary for the exercise or defense of legal claims.',
                  },
                  {
                    text: 'Right to Withdraw Consent- You have the right to revoke any consent you have previously given for the processing of your Personal Information at any time.',
                  },
                ],
              },
            ],
  ...
  LTT_BROADWAY_BANNER: {
    LTT: {
      BANNER_TITLE: 'Descoperiți cele mai bune spectacole West End',
      BANNER_SUBTEXT:
        'Bilete autorizate, locuri excelente, reduceri și recenzii de încredere',
    },
    BROADWAY: {
      BANNER_TITLE: 'Descoperiți cele mai bune spectacole Broadway',
      BANNER_SUBTEXT:
        'Bilete autorizate, locuri excelente, reduceri și recenzii de încredere',
    },
  },
