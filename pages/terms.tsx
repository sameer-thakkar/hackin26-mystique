    ...
    return (
      <div className="terms-container">
        ...
        <div className="text">
          ...
          constitute the entire and only agreement between you and this website,
          ...
          accept our Legal Terms, you should not access our Website. If you have
          already accessed our Website and do not accept our Legal Terms, you
        ...
        <div className="text">
          ...
          tours, activities, and other travel-related goods and services to the
          general public and has registered with our Website to offer their
          goods/services. We refer to a Member who purchases goods/services from
          ...
          <br />
          A “User” is a collective identifier that refers to either a Visitor or
          a Member.
          <br />
          A “Visitor” is someone who merely browses our Website.
          <br />
          All text, information, graphics, audio, video, and data offered
          through our Website, whether free to all or part of our paid features
          of our Website, are collectively known as our “Content”. We may refer
          to Content provided by our Members, whether as part of their Profile
          or in other postings to our Website, as “Member Content.” When we
          refer to our Website, our Content is included by reference.
        </div>
        ...
        <div className="text">
          ...
          Website. We reserve the right to investigate complaints or reported
          ...
          materials, IP addresses and traffic information, as allowed under our
          Privacy Policy.
        </div>
        ...
        <div className="text">
          ...
          notification of claimed infringement (to ensure that your notification
          complies with the requirement of the Digital Millennium Copyright Act,
        ...
        <div className="text">
          ...
          our affiliates, and other companies, in the form of words, graphics,
          and logos. Your use of our Website does not constitute any right or
          license for you to use such trademark, without the prior written
          permission of the corresponding trademark owner. Our Website is also
          protected under international copyrights. The copying, redistribution,
          use or publication by you of any portion of our Website is strictly
          prohibited. Your use of our Website does not grant you ownership
          rights of any kind in our Content or Website. As mentioned, we do not
          claim ownership of your Member Content, but by providing it to our
          Website, you do not receive any other rights in our Content other than
          what belongs to you already.
        </div>
        ...
        <div className="text">
          ...
          By linking to these Third Party Websites, we do not create or have an
          affiliation with, or sponsor such Third Party Websites. The inclusion
          of links within our Website does not constitute any endorsement,
          guarantee, warranty, or recommendation of such Third Party Websites.
          We have no control over the legal documents and privacy practices of
          third party websites; as such, you access any such Third Party
        ...
        <div className="text">
          ...
          combination thereof, including injury or damage to anyone’s computer,
          mobile phone, or other hardware or Website, related to or resulting
          from using, uploading, or downloading materials in connection with our
          Website. Under no circumstances will we be responsible for any loss or
          damage, including any loss or damage or personal injury or death,
          resulting from anyone’s use of our Website, or for any interactions
          between Users of our Website, whether online or offline.
        </div>
        ...
        <div className="text">
          ...
          your use of our Website; or (d) any delay or failure in performance of
          our Website. WE AND OUR AFFILIATES ARE NOT LIABLE FOR THE ACTS,
          ERRORS, OMISSIONS, REPRESENTATIONS, WARRANTIES, BREACHES OR NEGLIGENCE
          OR FOR ANY PERSONAL INJURIES, DEATH, PROPERTY DAMAGE, OR OTHER DAMAGES
          OR EXPENSES RESULTING THEREFROM. WE AND OUR AFFILIATES HAVE NO
          LIABILITY AND WILL MAKE NO WARRANTY, REFUND, OR OTHER RESTITUTION TO
          YOU WITH REGARDS TO OUR WEBSITE, OTHER THAN AS SPECIFIED HEREIN, FOR
          ANY REASON, INCLUDING, BUT NOT LIMITED TO, DELAYS, CANCELLATIONS,
          STRIKES, GOVERNMENTAL ISSUES, OR FORCE MAJEURE.
        </div>
        <div className="sub-heading">Arbitration</div>
        <div className="text">
          Any legal controversy or legal claim arising out of or relating to our
          Legal Terms and/or our Website, excluding legal action taken by us to
          collect or recover damages for, or obtain any injunction relating to
          intellectual property infringement, shall be settled solely by binding
          ...
          arbitration shall be conducted before an arbitrator selected by the
          American Arbitration Association in New York, NY, USA. The judgment of
          such arbitrator on award may be entered into any court having
          jurisdiction thereof. We may seek any interim or preliminary relief
          from a court of competent jurisdiction within state and federal courts
          of the State of New York as, necessary to protect the rights or
          property of you and us pending the completion of arbitration. Each
          party shall bear one-half of the arbitration fees and costs, but the
          prevailing party may seek return of such arbitration fees and
          reasonable attorney fees. ISSUES, OR FORCE MAJEURE.
        </div>
        <div className="sub-heading">General Terms</div>
        <div className="text">
          Our Legal Terms shall be treated as though it were executed and
          performed in New York, NY, USA, and shall be governed by and construed
          in accordance with the laws of the State of New York, USA, without
          regard to conflict of law principles. In addition, you agree to submit
          to the personal jurisdiction and venue of such courts. Any cause of
          action by you with respect to our Website, must be instituted within
          one (1) year after the cause of action arose or be forever waived and
          barred. Should any part of our Legal Terms be held invalid or
          ...
          and effect. To the extent that any Content in our Website conflicts or
          is inconsistent with our Legal Terms, our Legal Terms shall take
          precedence. Our failure to enforce any provision of our Legal Terms
