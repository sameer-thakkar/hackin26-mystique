...
export const NewRelicPerformanceMonitoring = ({
  ...
  ;NREUM.loader_config={accountID:"${ACCOUNT_ID}",trustKey:"${TRUST_KEY}",agentID:"${AGENT_ID}",licenseKey:"${LICENSE_KEY}",applicationID:"${APPLICATION_ID}"}
  ;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"${LICENSE_KEY}",applicationID:"${APPLICATION_ID}",sa:1}`,
      }}
    ></Script>
  );
};
