---
name: harden-pr
description: Use when hardening an open pull request through repeated review and fix cycles, especially when a PR is large, risky, under active review, or needs a deeper multi-lens pass before merge.
---
