...
const no: TDictionary = {
  ...
  COOKIE_CONSENT: {
    ...
    DESCRIPTION: `*   Informasjonskapsler er små filer som plasseres på datamaskinen, mobilenheten eller andre enheter av nettstedet/plattformen, og som blant annet inneholder informasjon om nettleserloggen din.
...
`,
  ...
  DESCRIPTORS: {
    ...
    HOTEL_PICKUP: 'Henting tilgjengelig',
    ...
    TRANSFERS: 'Transport er tilgjengelig',
    ...
    MODAL: {
      DETAILS: {
        ...
        PREVENTIVE_SAFETY_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Det er påbudt med smitteverneutstyr, for eksempel munnbind, for å komme inn til arrangementsstedet</li>
        ...
        SOCIAL_DISTANCING_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Arrangementsstedet er redesignet for å minimere kontakten mellom alle tilskuerne</li>
  ...
  INVENTORY_UNAVAILABLE: {
    ...
    MESSAGE: `Beklager! Alle opplevelser for denne datoen er enten utsolgt eller
