...
export const EXPERIMENT_NAMES = {
  ...
  PRODUCT_CARD_PHASE_0_EXPERIMENT: 'POI Card Revamp',
...
export const EXPERIMENTS = {
  ...
  [EXPERIMENT_NAMES.PRODUCT_CARD_PHASE_0_EXPERIMENT]: new Experiment(
    EXPERIMENT_NAMES.PRODUCT_CARD_PHASE_0_EXPERIMENT,  
    [VARIANTS.CONTROL, VARIANTS.TREATMENT],
    [100, 0]
  ),
