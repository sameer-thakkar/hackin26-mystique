...
export const TourComparisonTable = props => {
    ...
    return (
        <div
            className="product-comparision-table"
        ...
        >
            ...
            <div className="tour-options">
                {content_normalized_tours.toursArr.map((tour, index) => {
                    ...
                    const titleMaxLen =
                        content_normalized_tours.labels.title.max;
                                ...
                                <div className="content-blocks">
                                    ...
                                    {orderedLabels.map((label, blockIndex) => {
                                        ...
                                        const thisContentLen = block_content
                                            ? block_content.len
                                            : 0;
                                        const isLargestBlock =
                                            thisLabelMaxLen == thisContentLen;
                                        return (
                                            <div
                                                className={`block ${label.labelId}`}
                                                style={
                                                    blockStyles[label.labelId]
                                                }
                                                ref={el => {
                                                    if (isLargestBlock)
                                                        rowsRef.current[
