...
export const EXPERIMENT_NAMES = {
  ...
  MORE_DETAILS_POPUP_EXPERIMENT: 'More Details Popup Experiment',
};
...
export const EXPERIMENTS = {
  ...
  [EXPERIMENT_NAMES.MORE_DETAILS_POPUP_EXPERIMENT]: new Experiment(
    EXPERIMENT_NAMES.MORE_DETAILS_POPUP_EXPERIMENT,
    [VARIANTS.CONTROL, VARIANTS.TREATMENT],
    [50, 50]
  ),
