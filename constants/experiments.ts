...
export const EXPERIMENT_NAMES = {
  ...
  VIDEO_BANNER_BTWN_PRODUCT_CARDS_EXP: 'Video banner between product cards exp',
...
export const EXPERIMENTS = {
  ...
  [EXPERIMENT_NAMES.CONSENT_BANNER_EXPERIMENT]: new Experiment(
    EXPERIMENT_NAMES.CONSENT_BANNER_EXPERIMENT,
    [VARIANTS.CONTROL, VARIANTS.TREATMENT],
    [0, 100]
  ),
  ...
  [EXPERIMENT_NAMES.VIDEO_BANNER_BTWN_PRODUCT_CARDS_EXP]: new Experiment(
    EXPERIMENT_NAMES.VIDEO_BANNER_BTWN_PRODUCT_CARDS_EXP,
    [VARIANTS.CONTROL, VARIANTS.TREATMENT],
    [0, 100]
  ),
};
