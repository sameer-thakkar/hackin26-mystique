...
const tr: TDictionary = {
  ...
  COOKIE_CONSENT: {
    ...
    DESCRIPTION: `*   Çerezler, Web Sitesi/Platform tarafından bilgisayarınıza, mobil cihazınıza veya başka bir cihaza depolanan ve birçok kullanımının yanı sıra tarama geçmişinizin ayrıntılarını içeren küçük dosyalardır.
...
`,
    ...
    MODAL: {
      DETAILS: {
        ...
        PREVENTIVE_SAFETY_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Mekâna girmek için maske gibi koruyucu ekipmanların kullanılması zorunludur</li>
        ...
        SOCIAL_DISTANCING_MEASURES_DEFAULT: {
          DESCRIPTION: `<li>Tesis, tüm katılımcıların birbirleriyle temasını en aza indirecek şekilde yeniden tasarlanmıştır</li>
  ...
  INVENTORY_UNAVAILABLE: {
    ...
    MESSAGE: `Üzgünüz! Bu tarih için tüm deneyimler ya tükenmiştir ya da
  ...
  ITINERARY: {
    ...
    VIEW_DETAILS: 'Detayları görüntüle',
    VIEW_ALL_STOPS: 'Tüm duraklarını görüntüle',
    ...
    DESCRIPTORS: {
      ...
      ATTRACTION_COUNT: '{0} cazibe yeri',
      ACTIVITIES_COUNT: '{0} aktivite',
      ACTIVITY_COUNT: '{0} etkinlik',
